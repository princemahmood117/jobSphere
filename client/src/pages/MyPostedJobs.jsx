                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {jobs.map((job) => (
                      <tr key={job._id}>
                        ...
                        <td
                          className="px-4 py-4 text-sm text-gray-500  whitespace-normal break-words max-w-4xl"
                          title=""
                        >
                          {job.description}
                        </td>
...
//     const {data} = await axiosSecure.get(`/jobs/${user?.email}`)  // replaced axios with axiosSecure hook where 'import.meta.env.VITE_API_URL' and 'withCredentials:true' has been already set
//     setJobs(data)
//   }
...
//       <section className='container px-4 mx-auto pt-12'>
//         <div className='flex items-center gap-x-3'>
//           <h2 className='text-2xl font-medium text-gray-800 text-center'>My Posted Jobs here</h2>
